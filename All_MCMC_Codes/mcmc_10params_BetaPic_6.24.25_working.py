...
def calBase():
    datafile = "../betapic_field1.uvfits"
...
def lnprob(p0):
    ...
    #new parameters
    logmass_stell, incl, Rc, pp, pa, logmass, vsys, xoff, yoff, Rin = p0 
    ...
    c.append(chiSq(val["datafile"], model_name, dxy=val['cell'], dRA=RA_rad, dDec=Dec_rad, pbcor=pbcor1))
    c.append(chiSq(val["datafile"], model_name, dxy=val['cell'], dRA=-RA_rad, dDec=-Dec_rad, pbcor=pbcor2))
                                                                                                                                    #Doubled 
...
def MCMC(nsteps=2600, ndim=10, nwalkers=40, param_1=0.25, param_2=80, param_3=38, param_4= 1, param_5=45, param_6= -4, param_7 = 0.0, param_8 = 0.0, param_9 = 0.0 ,param_10 = 10, sigma_1=0.67, sigma_2=3, sigma_3=10, sigma_4=1, sigma_5=7, sigma_6=0.67, sigma_7 = 0.5, sigma_8 = 0.2, sigma_9 = 0.2, sigma_10 = 3, restart=False):
...
#param
    ...
    if restart == False:
        ...
        p0 = np.random.normal(loc=(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10), size=(nwalkers, ndim), scale=(sigma_1, sigma_2, sigma_3, sigma_4, sigma_5, sigma_6, sigma_7, sigma_8, sigma_9, sigma_10))
    ...
    for i, result in enumerate(run):
        ...
        df.columns = ["logmass_stell", "incl", "Rc", "pp", "pa", "logmass", "vsys", "xoff", "yoff", "Rin", "lnprobs"]
        df.to_csv('jul17_2024.csv', mode='w')
