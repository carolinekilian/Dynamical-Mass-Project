...
def calBase():
    datafile = "CO_timeavgsplit.uvcontsub.lsrk.split.split2.uvfits"
    imfile = "HD141569_T6.fits"
    vsys = 7.0
    distance = 117
...
def chiSq(modelfile, velaxis, datamoment, rms_clip, unique_id):
    visibilities(val['datafile'], modelfile, fileout='model_DMR', dxy=val['cell']/206265., dRA=0, dDec=0, pbcor=pbcor1, unique_id=unique_id)
...
def lnprob(p0):
    ...
    chi = chiSq(model_name, 'HD141569_T6.image.fits', 'HD141569_M9.fits', 5.0, unique_id)
                                                                                                                                    #Doubled 
...
def MCMC(nsteps=2600, ndim=8, nwalkers=40, param_1=0.33, param_2=175, param_3= -1, param_4 = 6.0, param_5 = 10, param_6 = 70.0, param_7=0.0, param_8=0.0, sigma_1=0.2, sigma_2=15, sigma_3=1, sigma_4 = 0.5, sigma_5 = 3, sigma_6 = 5, sigma_7=0.1, sigma_8=0.1, restart=False):
...
#param
    ...
    for i, result in enumerate(run):
        ...
        df.to_csv('june18_2025.csv', mode='w')
