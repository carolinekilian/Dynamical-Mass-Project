...
def calBase():
    datafile = "HD121617_spw2.ms.cvel.uvcontsub.line_channels.fits"
    imfile = "HD121617.fits"
    vsys = 7.0
    distance = 117
...
def lnprob(p0):
    ...
    chi = chiSq(model_name, 'HD121617.fits', 'HD121617_M9.fits', 5.0, unique_id)
                                                                                                                                    #Doubled 
...
def MCMC(nsteps=2600, ndim=8, nwalkers=40, param_1=0.28, param_2=18, param_3= -1, param_4 = 7.0, param_5 = 10, param_6 = 43.8, param_7=0.0, param_8=0.0, sigma_1=0.1, sigma_2=5, sigma_3=1, sigma_4 = 0.5, sigma_5 = 3, sigma_6 = 5, sigma_7=0.1, sigma_8=0.1, restart=False):
