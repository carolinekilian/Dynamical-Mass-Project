...
#    T_atm = 75.
    ...
    x = Disk(McoG=Mdisk, pp=pp, Rin=R_in, Rout=R_out, Rc=Rc, incl=incl, Mstar=M_stell, Zq0=80, Tmid0=T_mid, Tatm0=T_atm, sigbound=[0,math.inf])
    ...
    #print('new model')
    c.append(chiSq('hales_cvel_1d.uvfits', model_name, dxy=val['cell'], dRA=0.0, dDec=0.0, pbcor=pbcor1))
    c.append(chiSq('hales_cvel_2d.uvfits', model_name, dxy=val['cell'], dRA=0.0, dDec=0.0, pbcor=pbcor1))
    c.append(chiSq('hales_cvel_3d.uvfits', model_name, dxy=val['cell'], dRA=0.0, dDec=0.0, pbcor=pbcor1))
    c.append(chiSq('hales_cvel_4d.uvfits', model_name, dxy=val['cell'], dRA=0.0, dDec=0.0, pbcor=pbcor1))
                                                                                                                                    #Doubled 
...
def MCMC(nsteps=3000, ndim=11, nwalkers=30, param_1=0.25, param_2=85, param_3=20, param_4= -0.47, param_5=295, param_6= -5, param_7 = 6.0, param_8 = 0.0, param_9 = 0.0 ,param_10 = 10, param_11=10, sigma_1=0.3, sigma_2=1.7, sigma_3=10, sigma_4=1, sigma_5=7, sigma_6=0.67, sigma_7 = 0.2, sigma_8 = 0.2, sigma_9 = 0.2, sigma_10 = 3, sigma_11=3, restart=False):
...
#param
    ...
    for i, result in enumerate(run):
        ...
        df.to_csv('apr4_2025.csv', mode='w')
